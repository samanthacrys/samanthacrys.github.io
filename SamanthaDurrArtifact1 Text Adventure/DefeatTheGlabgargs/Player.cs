namespace DefeatTheGlabgargs
{
    ...
    public class Player
    {
        ...
        /// <summary>
        /// This retrieves the player's menu selection from the availavble options within the specified range.
        /// </summary>
        /// <remarks>
        /// This method presents various gameplay options based on the player's current state and avaiable resources.
        ...
        public bool AddRayGunOption(ref int maxSelect)
        {
            ...
            ++maxSelect;
            Console.WriteLine($"{maxSelect}) Shoot the Ray Gun at the labgarg.");
            return true;
        }
